 ...
 */
export const PIPELINE_COMMIT_MARKER_TTL = 300; // seconds; must stay > heartbeat cache TTL (180 s) + slack
export const PIPELINE_COMMIT_APPLY_GRACE_MS = 10_000; // apply lag + in-flight heartbeats + clock skew
